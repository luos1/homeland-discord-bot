  ...
  const embed = new EmbedBuilder()
    ...
    .setDescription(
      [
        ...
        '',
        '🎁 **친구 1명당 엄청난 보상!**',
        '• 친구 가입 즉시: **100 젬 + 1,000 골드 + 레어 장비**',
        '• 친구 Lv.10 달성: **200 젬** 추가!',
        '• 친구 Lv.30 달성: **500 젬** 추가!',
        '💎 **총 보상: 최대 800 젬 + 1,000 골드 + 레어 장비!**',
        '',
        '💰 **친구도 혜택!**',
        '• 가입 즉시: **2,000 골드**',
        '• Lv.10 달성: **100 젬**',
  ...
  const embed = new EmbedBuilder()
    ...
    .setDescription(
      [
        ...
        '',
        '즉시 지급 보상',
        `• 초대한 사람: 💠 보석 +${formatNumber(INVITE_REWARD_AMOUNTS.inviterOnJoinGems)} + 💰 골드 +${formatNumber(INVITE_REWARD_AMOUNTS.inviterOnJoinGold)}`,
        `• 초대한 사람: ✨ 레어 장비 1개 지급`,
